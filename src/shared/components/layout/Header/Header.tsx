...
import LocaleSwitcher from '@/features/location/LocalSwitcher';
  ...
  return (
    <div className='flex w-full mx-auto gap-2 items-center 2xl:max-w-[1536px] bg-white dark:bg-neutral-950 px-4 py-2 border-b border-gray-300 
      ...
      <div className='flex gap-2 ml-auto'>
        ...
        <Button variant='default' size='sm' className='bg-blue-500 hidden xsm:flex hover:bg-blue-600 
                        transition-colors duration-150 cursor-pointer dark:text-white'>
          <CircleUserRound />
